...
function Signup() {
  ...
  return (
    <div className="p-10 shadow-lg shadow-gray-600 ">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            className="w-full shadow-inner bg-white rounded-lg placeholder-black text-2xl p-4 border block mt-1"
            id="FirstName"
            type="text"
            name="FirstName"
            required
        ...
        <div className="flex items-center justify-between mt-8">
          <button
            type="submit"
            className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
