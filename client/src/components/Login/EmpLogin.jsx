  ...
  return (
    <div>
      <div className='grid shadow-2xl border max-w-[900px] mx-auto translate-y-24  grid-cols-1 lg:grid-cols-2'>
        <img className="hidden z-10 lg:block md:col-span-1 object-cover" src="https://images.unsplash.com/photo-1644224076179-31d622e21511?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Login background" />
