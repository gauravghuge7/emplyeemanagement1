...
function Sidebar({ activeBox, setActiveBox, notifactionCount }) {
    ...
    return (
       <nav>
            {isMobile ? <MobileNav /> : <aside className=" bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 my-4 ml-4  h-[calc(90vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0" style={{ marginTop: "5rem" }}>
                    ...
                    <ul className="mb-4 flex flex-col gap-1">
                        ...
                        <li>
                            <a className="" href="#" >
                                ...
                                >
                                    <span className="absolute top-0 left-3  rounded-[100px] bg-red-500 p-1 px-2">{count}</span>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
