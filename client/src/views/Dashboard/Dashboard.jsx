        ...
        <div className="m-4">
          <ul className="mb-4 flex flex-col gap-3">
            ...
            <li>
              <a className="" href="#" >
                <button
                  className={`middle none relative font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-5 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-2 px-4 capitalize ${activeTab === 'notification' && 'bg-gradient-to-tr from-blue-600 to-blue-400'}`}
                  type="button"
            ...
            <li>
              <a className="" href="#" >
                <button
                  className={`middle none relative font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-5 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-2 px-4 capitalize ${activeTab === 'history' && 'bg-gradient-to-tr from-blue-600 to-blue-400'}`}
                  type="button"
